...
def test_doors_properties(  # pylint: disable=C0116 # noqa: D103
    category, section_name, property_name, expected_class
):
    # Arrange
...
def test_windows_properties(  # pylint: disable=C0116 # noqa: D103
    category, section_name, property_name, expected_class
):
    # Arrange
    status = RemoteStatusModel(
...
def test_lock_status_properties(  # pylint: disable=C0116 # noqa: D103
    status, expected_last_updated, expected_doors_class, expected_windows_class
):
    # Arrange
